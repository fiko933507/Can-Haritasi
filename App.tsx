...
function BottomNav({ active, setActive }: { active: Tab; setActive: (t: Tab) => void }) {
  const items: { key: Tab; icon: IconName; label: string }[] = [{ key: 'home', icon: 'home', label: 'Ana Sayfa' }, { key: 'map', icon: 'map', label: 'Harita' }, { key: 'report', icon: 'add', label: '' }, { key: 'impact', icon: 'pulse', label: 'Etki' }, { key: 'profile', icon: 'person', label: 'Profil' }];
...
function AppInner() {
  ...
  return <View style={styles.app}>
    ...
    <SafeAreaView edges={active === 'map' ? [] : ['top']} style={styles.content}>
      ...
      {active === 'impact' && <Impact reports={reports} />}
