  ...
  render() {
    if (this.state.error) {
      return <SafeAreaView style={{ flex: 1, backgroundColor: '#FFF8EF', padding: 24, justifyContent: 'center' }}>
        ...
        <Text style={{ color: '#8B7770', fontSize: 14, lineHeight: 21, marginBottom: 16 }}>Başlangıçta bir uygulama hatası yakalandı. Aşağıdaki metni bize gönder.</Text>
...
const styles = StyleSheet.create({
  ...
  authOuter: { flex: 1, backgroundColor: '#FFF5E9' }, authSafe: { flex: 1, paddingHorizontal: 22, justifyContent: 'center' }, authBrand: { alignItems: 'center', marginBottom: 28 }, authLogo: { width: 68, height: 68, borderRadius: 25, backgroundColor: '#FF914D', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }, authTitle: { fontSize: 36, fontWeight: '900', color: GREEN, letterSpacing: -1 }, authSubtitle: { color: '#8B7770', textAlign: 'center', lineHeight: 20, marginTop: 8, maxWidth: 310 }, authCard: { backgroundColor: '#fff', borderRadius: 30, padding: 18, borderWidth: 1, borderColor: '#F0DED2' }, authTabs: { flexDirection: 'row', padding: 4, backgroundColor: '#F7E9DF', borderRadius: 18, marginBottom: 16 }, authTab: { flex: 1, paddingVertical: 10, borderRadius: 15, alignItems: 'center' }, authTabActive: { backgroundColor: '#fff' }, authTabText: { fontWeight: '800', color: '#8B7770' }, authTabTextActive: { color: GREEN }, input: { backgroundColor: '#FFFCF8', borderWidth: 1, borderColor: '#F0DED2', borderRadius: 18, paddingHorizontal: 15, height: 52, marginBottom: 10, color: GREEN, fontSize: 14 }, authButton: { height: 56, backgroundColor: CORAL, borderRadius: 22, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 9, marginTop: 4 }, authButtonText: { color: '#fff', fontWeight: '900', fontSize: 14 }, privacyRow: { flexDirection: 'row', gap: 8, marginTop: 14, alignItems: 'flex-start' }, privacyText: { flex: 1, fontSize: 10, lineHeight: 15, color: '#806E67' },
