...
// Can Haritası: urban rescue / field-network identity.
// Intentionally separated from VELTRAI's soft cream-mint-coral visual language.
const GREEN = '#0B1F33';
const MINT = '#E6EEFF';
const CORAL = '#2F6BFF';
const CREAM = '#F4F7FB';
...
class AppErrorBoundary extends React.Component<{ children: React.ReactNode }, { error: string | null }> {
  ...
  render() {
    if (this.state.error) {
      return <SafeAreaView style={{ flex: 1, backgroundColor: '#F4F7FB', padding: 24, justifyContent: 'center' }}>
        <Text style={{ color: '#0B1F33', fontSize: 24, fontWeight: '900', marginBottom: 12 }}>Can Haritası açılamadı</Text>
        <Text style={{ color: '#5F7286', fontSize: 14, lineHeight: 21, marginBottom: 16 }}>Başlangıçta bir uygulama hatası yakalandı. Aşağıdaki metni bize gönder.</Text>
...
const styles = StyleSheet.create({
  ...
  authOuter: { flex: 1, backgroundColor: GREEN }, authSafe: { flex: 1, paddingHorizontal: 22, justifyContent: 'center' }, authBrand: { alignItems: 'center', marginBottom: 28 }, authLogo: { width: 62, height: 62, borderRadius: 14, backgroundColor: CORAL, alignItems: 'center', justifyContent: 'center', marginBottom: 16 }, authTitle: { fontSize: 34, fontWeight: '900', color: '#fff', letterSpacing: -1 }, authSubtitle: { color: '#B8CBE0', textAlign: 'center', lineHeight: 20, marginTop: 8, maxWidth: 310 }, authCard: { backgroundColor: '#fff', borderRadius: 18, padding: 18, borderWidth: 1, borderColor: '#DCE5EE' }, authTabs: { flexDirection: 'row', padding: 4, backgroundColor: '#E8EEF5', borderRadius: 10, marginBottom: 16 }, authTab: { flex: 1, paddingVertical: 10, borderRadius: 7, alignItems: 'center' }, authTabActive: { backgroundColor: '#fff' }, authTabText: { fontWeight: '800', color: '#74869A' }, authTabTextActive: { color: GREEN }, input: { backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: '#DCE5EE', borderRadius: 10, paddingHorizontal: 15, height: 52, marginBottom: 10, color: GREEN, fontSize: 14 }, authButton: { height: 54, backgroundColor: CORAL, borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 9, marginTop: 4 }, authButtonText: { color: '#fff', fontWeight: '900', fontSize: 14 }, privacyRow: { flexDirection: 'row', gap: 8, marginTop: 14, alignItems: 'flex-start' }, privacyText: { flex: 1, fontSize: 10, lineHeight: 15, color: '#66788A' },
