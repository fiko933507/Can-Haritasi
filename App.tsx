...
type Tab = 'home' | 'map' | 'report' | 'community' | 'profile';
...
function Home({ reports, loading, position, refresh, goReport, userName, onHelp, onModerated }: {
  ...
  return <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
    ...
    <LinearGradient colors={[CORAL, '#FF9A7E', '#F6B36C']} style={styles.hero}>
      <View style={styles.heroGlow} />
      <View style={styles.heroPawBubble}><Ionicons name="paw" size={24} color="rgba(255,255,255,.9)" /></View>
      <View style={styles.live}><View style={styles.liveDot} /><Text style={styles.liveText}>MAHALLENDEKİ CANLAR</Text></View>
...
function AppInner() {
  ...
  return <View style={styles.app}>
    ...
    <SafeAreaView edges={active === 'map' ? [] : ['top']} style={styles.content}>
      {active === 'home' && <Home reports={reports} loading={loading} position={position} refresh={refresh} goReport={() => setActive('report')} userName={userName} onHelp={help} onModerated={refreshAfterPublish} />}
...
const styles = StyleSheet.create({
  ...
  authOuter: { flex: 1, backgroundColor: '#FCE7DE' }, authSafe: { flex: 1, paddingHorizontal: 22, justifyContent: 'center' }, authBrand: { alignItems: 'center', marginBottom: 28 }, authLogo: { width: 62, height: 62, borderRadius: 22, backgroundColor: CORAL, alignItems: 'center', justifyContent: 'center', marginBottom: 16 }, authTitle: { fontSize: 34, fontWeight: '900', color: GREEN, letterSpacing: -1 }, authSubtitle: { color: '#61756D', textAlign: 'center', lineHeight: 20, marginTop: 8, maxWidth: 310 }, authCard: { backgroundColor: CREAM, borderRadius: 26, padding: 18 }, authTabs: { flexDirection: 'row', padding: 4, backgroundColor: '#E9E8E2', borderRadius: 14, marginBottom: 16 }, authTab: { flex: 1, paddingVertical: 10, borderRadius: 11, alignItems: 'center' }, authTabActive: { backgroundColor: '#fff' }, authTabText: { fontWeight: '800', color: '#7C8581' }, authTabTextActive: { color: GREEN }, input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E4E3DD', borderRadius: 15, paddingHorizontal: 15, height: 52, marginBottom: 10, color: GREEN, fontSize: 14 }, authButton: { height: 54, backgroundColor: CORAL, borderRadius: 16, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 9, marginTop: 4 }, authButtonText: { color: '#fff', fontWeight: '900', fontSize: 14 }, privacyRow: { flexDirection: 'row', gap: 8, marginTop: 14, alignItems: 'flex-start' }, privacyText: { flex: 1, fontSize: 10, lineHeight: 15, color: '#65716C' },
  scroll: { padding: 18, paddingBottom: 30 }, header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 }, eyebrow: { fontSize: 9, letterSpacing: 1.4, color: '#7A847F', fontWeight: '800', maxWidth: 220 }, logo: { fontSize: 24, fontWeight: '900', letterSpacing: -.8, color: GREEN }, headerActions: { flexDirection: 'row', gap: 8, alignItems: 'center' }, iconButton: { width: 42, height: 42, borderRadius: 15, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' }, avatar: { width: 42, height: 42, borderRadius: 15, backgroundColor: MINT, alignItems: 'center', justifyContent: 'center' }, avatarText: { color: GREEN, fontWeight: '900' },
  hero: { borderRadius: 30, padding: 22, overflow: 'hidden', shadowColor: CORAL, shadowOpacity: .12, shadowRadius: 16, shadowOffset: { width: 0, height: 8 } }, heroPawBubble: { position: 'absolute', right: 20, bottom: 18, width: 52, height: 52, borderRadius: 20, backgroundColor: 'rgba(255,255,255,.16)', alignItems: 'center', justifyContent: 'center' }, heroGlow: { position: 'absolute', width: 180, height: 180, borderRadius: 90, backgroundColor: 'rgba(255,255,255,.06)', right: -45, top: -60 }, live: { flexDirection: 'row', alignItems: 'center', gap: 7 }, liveDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#FFB5A1' }, liveText: { fontSize: 10, color: '#D8E8E3', fontWeight: '800', letterSpacing: 1.4 }, heroTitle: { fontSize: 30, lineHeight: 35, fontWeight: '900', letterSpacing: -1.1, color: '#fff', marginTop: 16 }, heroBody: { fontSize: 13, lineHeight: 20, color: '#D9E9E4', marginTop: 12, maxWidth: '94%' }, heroButton: { alignSelf: 'flex-start', marginTop: 21, backgroundColor: '#fff', borderRadius: 15, paddingVertical: 13, paddingHorizontal: 16, flexDirection: 'row', gap: 12, alignItems: 'center' }, heroButtonText: { color: GREEN, fontWeight: '800', fontSize: 13 },
  statsRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 22 }, stat: { flex: 1, alignItems: 'center', justifyContent: 'center', minHeight: 40 }, statValue: { fontSize: 18, fontWeight: '900', color: GREEN }, statLabel: { fontSize: 9, lineHeight: 13, textAlign: 'center', color: '#7D8682', marginTop: 3 }, statDivider: { width: 1, height: 34, backgroundColor: '#DDDCD6' }, sectionHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: 4 }, sectionTitle: { fontSize: 20, fontWeight: '900', letterSpacing: -.4, color: GREEN }, sectionSub: { fontSize: 12, color: '#818984', marginTop: 3 }, filters: { gap: 8, paddingVertical: 15 }, pill: { paddingHorizontal: 14, paddingVertical: 9, borderRadius: 20, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E4DE' }, pillActive: { backgroundColor: GREEN, borderColor: GREEN }, pillText: { fontSize: 12, fontWeight: '700', color: GREEN }, chipRow: { flexDirection: 'row', gap: 8, marginBottom: 20 },
  caseCard: { backgroundColor: '#fff', borderRadius: 20, padding: 12, marginBottom: 12, flexDirection: 'row', shadowColor: '#173D35', shadowOpacity: .05, shadowRadius: 14, shadowOffset: { width: 0, height: 6 } }, caseImage: { width: 82, minHeight: 104, borderRadius: 15, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }, casePhoto: { width: '100%', height: '100%', position: 'absolute' }, verified: { position: 'absolute', bottom: 7, right: 7, width: 18, height: 18, borderRadius: 9, backgroundColor: '#4BA67E', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#fff' }, caseBody: { flex: 1, paddingLeft: 13, paddingVertical: 2 }, caseTop: { flexDirection: 'row', justifyContent: 'space-between', gap: 8 }, caseName: { fontSize: 16, fontWeight: '900', color: GREEN }, distance: { fontSize: 10, color: '#6E7974', fontWeight: '700' }, caseType: { fontSize: 11, lineHeight: 16, color: '#77807B', marginTop: 3 }, urgencyRow: { flexDirection: 'row', gap: 4, marginTop: 10 }, urgencyDot: { width: 18, height: 4, borderRadius: 2, backgroundColor: '#E7E8E4' }, caseBottom: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 9 }, time: { fontSize: 10, color: '#949B97' }, miniButton: { minWidth: 74, minHeight: 30, backgroundColor: GREEN, paddingVertical: 7, paddingHorizontal: 12, borderRadius: 10, alignItems: 'center', justifyContent: 'center' }, miniButtonDone: { backgroundColor: MINT }, miniButtonText: { fontSize: 10, fontWeight: '800', color: '#fff' }, emptyCard: { backgroundColor: '#fff', borderRadius: 20, padding: 24, alignItems: 'center', marginBottom: 12 }, emptyTitle: { color: GREEN, fontWeight: '900', fontSize: 16, marginTop: 10 }, emptyText: { color: '#7A837F', textAlign: 'center', lineHeight: 18, fontSize: 12, marginTop: 6 }, outlineButton: { borderWidth: 1, borderColor: GREEN, borderRadius: 13, paddingVertical: 10, paddingHorizontal: 18, marginTop: 14, minWidth: 120, alignItems: 'center' }, outlineButtonText: { color: GREEN, fontWeight: '800' }, trustCard: { marginTop: 8, backgroundColor: MINT, borderRadius: 20, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 12 }, trustIcon: { width: 42, height: 42, borderRadius: 14, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' }, trustTitle: { fontSize: 13, fontWeight: '900', color: GREEN }, trustText: { fontSize: 10, lineHeight: 15, color: '#577068', marginTop: 3 },
  navSafe: { backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#EEEDE8' }, nav: { height: 67, flexDirection: 'row', alignItems: 'center' }, navItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 3 }, navLabel: { fontSize: 9, fontWeight: '700', color: '#78817D' }, addButton: { width: 50, height: 50, borderRadius: 18, backgroundColor: CORAL, alignItems: 'center', justifyContent: 'center', marginTop: -25, shadowColor: CORAL, shadowOpacity: .32, shadowRadius: 10, shadowOffset: { width: 0, height: 5 } },
  mapSafe: { position: 'absolute', top: 0, left: 0, right: 0, zIndex: 3 }, mapHeader: { paddingHorizontal: 18, paddingTop: 10, flexDirection: 'row', justifyContent: 'space-between' }, locationPill: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 15, borderRadius: 22, backgroundColor: '#fff', maxWidth: SCREEN - 130 }, locationText: { fontSize: 12, fontWeight: '800', color: GREEN }, realMapWrap: { flex: 1, overflow: 'hidden' }, realMap: { flex: 1 }, mapPin: { width: 42, height: 42, borderRadius: 21, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: '#fff', shadowColor: '#000', shadowOpacity: .18, shadowRadius: 6, shadowOffset: { width: 0, height: 3 } }, mapPinActive: { backgroundColor: CORAL, transform: [{ scale: 1.12 }] }, youMarkerReal: { width: 26, height: 26, borderRadius: 13, backgroundColor: 'rgba(43,118,242,.24)', alignItems: 'center', justifyContent: 'center' }, youCore: { width: 12, height: 12, borderRadius: 6, backgroundColor: '#2B76F2', borderWidth: 2, borderColor: '#fff' }, mapLoadingOverlay: { position: 'absolute', left: 18, right: 18, top: '45%', backgroundColor: 'rgba(255,255,255,.94)', borderRadius: 16, padding: 14, flexDirection: 'row', gap: 10, alignItems: 'center', justifyContent: 'center' }, mapLoadingText: { fontSize: 11, fontWeight: '700', color: GREEN }, mapSheet: { backgroundColor: CREAM, padding: 15, borderTopLeftRadius: 28, borderTopRightRadius: 28 }, handle: { width: 38, height: 4, borderRadius: 2, backgroundColor: '#C7C7C1', alignSelf: 'center', marginBottom: 10 }, mapCount: { fontSize: 15, fontWeight: '900', color: GREEN, marginBottom: 10 },
  formScroll: { padding: 22, paddingBottom: 36 }, formHeader: { marginTop: 10 }, formTitle: { fontSize: 34, lineHeight: 39, fontWeight: '900', letterSpacing: -1.1, color: GREEN }, formSub: { fontSize: 13, color: '#77817C', marginTop: 8 }, steps: { flexDirection: 'row', gap: 7, marginVertical: 27 }, step: { height: 5, flex: 1, borderRadius: 3, backgroundColor: '#DDDCD6' }, stepActive: { backgroundColor: CORAL }, fieldLabel: { fontSize: 10, fontWeight: '900', letterSpacing: 1.2, color: '#68736E', marginBottom: 10, marginTop: 5 }, needGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 23 }, needCard: { width: '48%', height: 92, borderRadius: 18, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E4DE', padding: 15, justifyContent: 'space-between' }, needCardActive: { backgroundColor: GREEN, borderColor: GREEN }, needText: { fontSize: 13, fontWeight: '900', color: GREEN }, textarea: { height: 120, backgroundColor: '#fff', borderRadius: 18, padding: 15, fontSize: 13, lineHeight: 19, color: GREEN, textAlignVertical: 'top', borderWidth: 1, borderColor: '#E5E4DE' }, primaryButton: { marginTop: 24, minHeight: 55, minWidth: 210, borderRadius: 17, backgroundColor: CORAL, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 10, paddingHorizontal: 18 }, primaryButtonText: { fontSize: 14, fontWeight: '900', color: '#fff' }, backText: { textAlign: 'center', padding: 15, color: GREEN, fontWeight: '700' }, locationCard: { backgroundColor: '#fff', borderRadius: 18, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 25 }, locationMap: { width: 58, height: 58, borderRadius: 14, backgroundColor: '#E7E4DC', alignItems: 'center', justifyContent: 'center' }, locationTitle: { fontSize: 13, fontWeight: '900', color: GREEN }, locationSub: { fontSize: 11, lineHeight: 15, color: '#7B837F', marginTop: 3 }, photoActions: { flexDirection: 'row', gap: 10 }, photoAction: { flex: 1, height: 120, borderRadius: 20, borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#AEB7B2', alignItems: 'center', justifyContent: 'center', padding: 14 }, photoTitle: { fontSize: 13, fontWeight: '900', color: GREEN, marginTop: 8 }, photoSub: { fontSize: 10, lineHeight: 15, textAlign: 'center', color: '#7A847F', marginTop: 8 }, photoPreviewWrap: { height: 210, borderRadius: 20, overflow: 'hidden' }, photoPreview: { width: '100%', height: '100%' }, removePhoto: { position: 'absolute', top: 10, right: 10, width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(0,0,0,.65)', alignItems: 'center', justifyContent: 'center' }, reviewCard: { backgroundColor: '#fff', borderRadius: 22, padding: 20 }, reviewTitle: { fontSize: 20, fontWeight: '900', color: GREEN, marginBottom: 14 }, infoRow: { flexDirection: 'row', gap: 13, alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#EEEDE8' }, infoLabel: { fontSize: 10, color: '#848C88' }, infoValue: { fontSize: 13, fontWeight: '800', color: GREEN, marginTop: 2 }, safetyNote: { backgroundColor: MINT, borderRadius: 14, padding: 12, flexDirection: 'row', gap: 10, marginTop: 15 }, safetyNoteText: { flex: 1, fontSize: 10, lineHeight: 15, color: '#526B63' }, successWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 36 }, successCircle: { width: 90, height: 90, borderRadius: 45, backgroundColor: '#49A27B', alignItems: 'center', justifyContent: 'center' }, successTitle: { fontSize: 28, fontWeight: '900', color: GREEN, marginTop: 25 }, successText: { fontSize: 13, lineHeight: 20, textAlign: 'center', color: '#707A75', marginTop: 10 },
  pageTitle: { fontSize: 30, fontWeight: '900', letterSpacing: -1, color: GREEN }, pageSub: { fontSize: 13, color: '#78827D', marginTop: 4, marginBottom: 20 }, impactHero: { borderRadius: 26, padding: 22, alignItems: 'center' }, impactEyebrow: { fontSize: 10, fontWeight: '900', letterSpacing: 1.5, color: '#FFE5DD' }, impactNumber: { fontSize: 60, fontWeight: '900', color: '#fff', marginTop: 6 }, impactLabel: { fontSize: 14, fontWeight: '800', color: '#fff' }, impactLine: { height: 1, width: '90%', backgroundColor: 'rgba(255,255,255,.3)', marginVertical: 17 }, impactQuote: { fontSize: 12, fontStyle: 'italic', color: '#FFF0EB', textAlign: 'center' },

  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 }, statusDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#C9D0CC' }, statusDotActive: { backgroundColor: '#55A47D' }, statusText: { fontSize: 9, fontWeight: '800', color: '#6F7D76' }, privacyChoiceRow: { gap: 8, marginBottom: 22 }, privacyChoice: { minHeight: 70, borderRadius: 18, borderWidth: 1, borderColor: '#E5E4DE', backgroundColor: '#fff', padding: 13, flexDirection: 'row', gap: 10, alignItems: 'center' }, privacyChoiceActive: { backgroundColor: GREEN, borderColor: GREEN }, privacyChoiceTitle: { color: GREEN, fontSize: 12, fontWeight: '900' }, privacyChoiceText: { color: '#7A847F', fontSize: 9, lineHeight: 14, marginTop: 2 }, duplicateWarning: { marginTop: 14, borderRadius: 15, padding: 12, backgroundColor: '#FFF1D9', flexDirection: 'row', gap: 10, alignItems: 'flex-start' }, duplicateTitle: { color: '#8C5529', fontWeight: '900', fontSize: 11 }, duplicateText: { color: '#8B684C', fontSize: 9, lineHeight: 14, marginTop: 3 },
