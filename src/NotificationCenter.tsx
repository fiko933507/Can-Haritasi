...
const styles = StyleSheet.create({
  ...
  circle: { width: 46, height: 46, borderRadius: 23, backgroundColor: COLORS.paper, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.line },
  ...
  paw: { width: 48, height: 48, borderRadius: 24, backgroundColor: COLORS.orange, alignItems: 'center', justifyContent: 'center' },
  pushCard: { backgroundColor: COLORS.paper, borderRadius: 42, padding: 15, flexDirection: 'row', gap: 11, alignItems: 'center', borderWidth: 1, borderColor: COLORS.line },
  pushIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: COLORS.sky, alignItems: 'center', justifyContent: 'center' },
  pushTitle: { fontSize: 13, fontWeight: '900', color: COLORS.forestDark },
  pushText: { fontSize: 9, lineHeight: 14, color: '#795F55', marginTop: 3 },
  enableButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: COLORS.coral, alignItems: 'center', justifyContent: 'center' },
  ...
  empty: { width: 286, minHeight: 286, alignSelf: 'center', backgroundColor: COLORS.paper, borderRadius: 143, padding: 34, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.line },
  emptyPaw: { width: 72, height: 72, borderRadius: 36, backgroundColor: COLORS.coralSoft, alignItems: 'center', justifyContent: 'center' },
  ...
  emptyButton: { minHeight: 44, borderRadius: 22, backgroundColor: COLORS.apricot, paddingHorizontal: 18, marginTop: 15, flexDirection: 'row', gap: 7, alignItems: 'center', justifyContent: 'center' },
  emptyButtonText: { color: COLORS.forestDark, fontSize: 10, fontWeight: '900' },
  note: { flexDirection: 'row', gap: 10, backgroundColor: COLORS.mint, borderRadius: 36, padding: 15, marginTop: 16, alignItems: 'center', borderWidth: 1, borderColor: COLORS.line },
