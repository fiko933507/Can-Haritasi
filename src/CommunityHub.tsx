...
const styles = StyleSheet.create({
  ...
  smallTip: { width: 170, minHeight: 170, backgroundColor: COLORS.paper, borderRadius: 85, borderWidth: 1, borderColor: COLORS.line, padding: 25, alignItems: 'center', justifyContent: 'center' },
  ...
  firstAidCard: { backgroundColor: COLORS.paper, borderRadius: 42, borderWidth: 1, borderColor: COLORS.line, padding: 16 },
  ...
  pointCard: { backgroundColor: COLORS.paper, borderRadius: 34, padding: 12, borderWidth: 1, borderColor: COLORS.line, flexDirection: 'row', gap: 10, alignItems: 'center', marginBottom: 8 },
  ...
  footerCard: { marginTop: 24, backgroundColor: COLORS.sage, borderRadius: 39, padding: 17, flexDirection: 'row', gap: 11, alignItems: 'flex-start' },
